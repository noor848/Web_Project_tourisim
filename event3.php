...
<div class="row mb-5">
<div class=" A "style="margin-top:7%;color:rgb(255,90,44); width:100%; height:150px; text-align:center;font-size:80px;margin-left:5%;font-weight:bold;text-shadow: 8px -8px 3px #FF9072;">
...
while($x2=mysqli_fetch_array($d)){
 ...
 <?php }?>
       ...
       $c=$c-3;
$query1="select * from blogs limit 0,3";
...
">
    ...
    <div class="container">
        ...
        $c=mysqli_num_rows($x1);
       $c=$c-3;
$query1="select * from blogs limit 1 offset 5";
$x1=mysqli_query($conn, $query1);
...
<form id="form2">
<h6 class="del"><a href="event3?i=<?php echo $arr['id_B'];?>&j=<?php echo $arr['id_u'];?>" class="btn btn-danger 
...
header("refresh:1;url=http://localhost/project_skyFly/event3#i");
 }
}}?>
<?php
...
<nav aria-label="...">
  <ul class="pagination">
    <li class="page-item ">
      <a class="page-link" href="event2#i">Previous</a>
    </li>
    <li class="page-item "><a class="page-link" href="event1#i">1</a></li>
    <li class="page-item ">
    ...
    <li class="page-item active" ><a class="page-link" href="http://localhost/project_skyFly/event3#i">3</a>
    </li>
    <li class="page-item disabled" >
      <a class="page-link " href="http://localhost/project_skyFly/event2#i">Next</a>
    </li>
  </ul>
</nav>
</div>
