...
<div class="col-md-4" style="  font-family: 'Merriweather', serif;">
<div class="im1 w-100">
  ...
  <div class="row">
    <div class="col-md-4 col-sm-12">
      <div class="list-group" id="list-tab" role="tablist">
        ...
        <a class="list-group-item list-group-item-action active  cd tabv" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home"><h4>A seven-mile underwater</h4>
...
">
    ...
    <div class="container">
       ...
       $c=$c-3;
$query1="select * from blogs limit 1 offset 3";
$x1=mysqli_query($conn, $query1);
...
<form id="form2">
<h6 class="del"><a href="event1?i=<?php echo $arr['id_B'];?>&j=<?php echo $arr['id_u'];?>" class="btn btn-danger 
...
header("refresh:1;url=http://localhost/project_skyFly/event1#i");
 }
}}?>
<?php
...
<nav aria-label="...">
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="http://localhost/project_skyFly/event2#i">3</a></li>
    <li class="page-item">
...
<script >
var xx= document.getElementsByClassName('cd').contains('active');
